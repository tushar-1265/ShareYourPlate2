...
const Hero = () => {
  return (
    <>
      <div className="main_container bg-black overflow-hidden h-full lg:h-screen w-full px-5 lg:pl-48 mt-10 lg:mt-0 flex flex-col lg:flex-row items-center justify-center">
        <div
        ...
        >
          ...
          >
            {" "}
            distribute food to the people in need.
          </span>
