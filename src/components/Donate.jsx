...
const Donate = () => {
  ...
  return (
    <>
      ...
      <div
        id="waitlist"
        className="container rounded-xl space-y-5 lg:space-x-6 bg-[rgba(255,255,255,0.2)] lg:mx-auto lg:w-3/4 p-10 my-10 mt-32 text-white flex flex-col lg:flex-row items-center justify-center"
      >
        <div className="fomo">
        ...
        <form className="flex flex-col w-full  lg:w-1/2 space-y-8" action="">
          <input
            ...
            className="p-4 rounded-lg w-full outline-none bg-[rgba(255,255,255,0.2)] border border-[rgba(255,255,255,0.2)]"
            type="text"
            name="name"
            id="name"
