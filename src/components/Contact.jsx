        ...
        <div
            ...
            <div className={`contact relative transition-all duration-1000  backdrop-blur-3xl z-10 lg:top-24 top-10 lg:flex border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,1)] shadow-2xl shadow-black rounded-2xl m-1 lg:p-8 lg:mx-32`}>
                ...
                <div className="form p-6 lg:p-0 lg:w-full">
                    <h1 className='text-2xl font-bold font-jost'>Contact Us
                    </h1>
                    <form className='flex pt-8 pb-5 space-y-6 flex-col' action="https://formsubmit.co/agarwaltushar255@gmail.com" method='post'>
                        ...
                        <textarea required className={` transition-all duration-300 outline-none border-slate-400 drop-shadow-sm border-2 rounded-xl p-4`} name="message" id="" placeholder='Tell Us About Your Suggestions or Enquiry' cols="30" rows="4"></textarea>
